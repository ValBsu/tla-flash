...
import {
  Archive, ArrowDownToLine, Check, ChevronDown, FilePlus2, Folder, Grid2X2, ImagePlus, LayoutGrid, Menu, Mic, MoreHorizontal, Plus, Redo2, Search, Share2, Sparkles, Trash2, Undo2, Upload, X,
} from 'lucide-react'
